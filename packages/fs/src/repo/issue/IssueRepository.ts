  ...
  searchByQuery(query: string): IssueBundle[] {
    const fuse = new Fuse(this.list(), {
      keys: [
        ...
        'issue.title.en-SG',
        'evidence.text',
        'impactEvents.entity.serviceId',
        'impactEvents.entity.stationId',
        'impactEvents.serviceScopes.stationId',
        'impactEvents.serviceScopes.fromStationId',
        'impactEvents.serviceScopes.toStationId',
      ],
      includeScore: true,
      threshold: 0.8,
    });
    const searchResults = fuse.search({
      $or: [
        ...
        { 'evidence.text': query },
        { 'impactEvents.entity.serviceId': query },
        { 'impactEvents.entity.stationId': query },
        { 'impactEvents.serviceScopes.stationId': query },
        { 'impactEvents.serviceScopes.fromStationId': query },
        { 'impactEvents.serviceScopes.toStationId': query },
      ] as Expression[],
    });
